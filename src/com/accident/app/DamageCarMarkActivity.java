...
public class DamageCarMarkActivity extends Activity {
	...
	protected void saveBitmap() {
		try {
			...
			Toast.makeText(DamageCarMarkActivity.this,
			...
			Toast.makeText(DamageCarMarkActivity.this, "Save failed", 0).show();
			e.printStackTrace();
		}
	}
